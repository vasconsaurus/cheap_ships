...
vehicle01.photos.attach(io: URI.open(url01), content_type: 'image/png', filename: vehicle01.name)
...
vehicle02.photos.attach(io: URI.open(url02), content_type: 'image/png', filename: vehicle02.name)
...
vehicle03.photos.attach(io: URI.open(url03), content_type: 'image/png', filename: vehicle03.name)
